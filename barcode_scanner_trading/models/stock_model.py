...
class StockInventory(models.Model):
    ...
    def barcode_scanner_trading_get_inventory_lines_values(self,product_id):
    ...
    def _add_product(self, barcode):
        ...
        if self.env.user.company_id.sudo().sh_inven_adjt_barcode_scanner_warn_sound:
            warm_sound_code = "BARCODE_SCANNER_TRADING_"     
        ...
        if self and self.state != 'confirm':
            ...
            if search_lines:
                ...
                if product:
                    lines_vals = self.barcode_scanner_trading_get_inventory_lines_values(product.id)
