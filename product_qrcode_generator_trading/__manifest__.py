...
{
    "name": "Product QR Code Generator for Trading",
    ...
    "summary": " Default Make QR Module,New Product QR Generate App,Existing Product QR Generate Application, Existing Multi Product QR Create, Custom Product QR Generator Odoo.",
